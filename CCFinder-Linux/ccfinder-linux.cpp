...
{
	cout << "CC Finder by independent v.10 https://GitHub.com/HackWeiser360 All rights reserved" << std::endl;
	cout << "Please wait a few hours this will take a while..." << std::endl;
	cout << "---" << std::endl;
	std::ofstream fout("CCFinder.log", ios::app);
	fout << "CC Finder by independent v1.0 https://GitHub.com/HackWeiser360 All rights reserved" << std::endl;
